...
export class ArtworksService {
     ...
     */
    public getArtworks(limit: number, offset: number, name?: string, description?: string, artists?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ArtworksResponse>;
    public getArtworks(limit: number, offset: number, name?: string, description?: string, artists?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ArtworksResponse>>;
    public getArtworks(limit: number, offset: number, name?: string, description?: string, artists?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ArtworksResponse>>;
    public getArtworks(limit: number, offset: number, name?: string, description?: string, artists?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
